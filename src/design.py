...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\Avasam\\Documents\\Git\\Auto-Split\\scripts\\../res\\../../../../VideoAutoSplitter/icon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.splitimagefolderLabel.setGeometry(QtCore.QRect(80, 13, 98, 16))
        ...
        self.splitimagefolderLineEdit.setGeometry(QtCore.QRect(187, 11, 247, 22))
        ...
        self.similaritythresholdDoubleSpinBox.setGeometry(QtCore.QRect(160, 390, 64, 22))
        ...
        self.startautosplitterButton.setGeometry(QtCore.QRect(510, 425, 101, 31))
        ...
        self.resetButton.setGeometry(QtCore.QRect(510, 385, 101, 31))
        ...
        self.skipsplitButton.setGeometry(QtCore.QRect(560, 250, 75, 24))
        ...
        self.undosplitLineEdit.setGeometry(QtCore.QRect(310, 391, 81, 20))
        ...
        self.skipsplitLineEdit.setGeometry(QtCore.QRect(310, 365, 81, 20))
        ...
        self.resetLineEdit.setGeometry(QtCore.QRect(310, 339, 81, 20))
        ...
        self.setsplithotkeyButton.setGeometry(QtCore.QRect(400, 314, 71, 21))
        ...
        self.setresethotkeyButton.setGeometry(QtCore.QRect(400, 339, 71, 21))
        ...
        self.setskipsplithotkeyButton.setGeometry(QtCore.QRect(400, 365, 71, 21))
        ...
        self.setundosplithotkeyButton.setGeometry(QtCore.QRect(400, 391, 71, 21))
        ...
        self.line_live_bottom.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_live_bottom.setLineWidth(1)
        self.line_live_bottom.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        ...
        self.line_live_top.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_live_top.setLineWidth(1)
        self.line_live_top.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        ...
        self.line_live_right.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_live_right.setLineWidth(1)
        self.line_live_right.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line_live_right.setObjectName("line_live_right")
        self.line_left = QtWidgets.QFrame(self.centralwidget)
        self.line_left.setGeometry(QtCore.QRect(230, 296, 2, 163))
        ...
        self.line_live_left.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_live_left.setLineWidth(1)
        self.line_live_left.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        ...
        self.line_split_left.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_split_left.setLineWidth(1)
        self.line_split_left.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        ...
        self.line_split_right.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_split_right.setLineWidth(1)
        self.line_split_right.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        ...
        self.line_split_top.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.line_split_top.setLineWidth(1)
        self.line_split_top.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        ...
        self.comparisonmethodComboBox.setGeometry(QtCore.QRect(133, 299, 91, 22))
        ...
        self.pauseDoubleSpinBox.setGeometry(QtCore.QRect(160, 430, 64, 22))
        ...
        self.custompausetimesCheckBox.setGeometry(QtCore.QRect(10, 440, 128, 17))
        self.custompausetimesCheckBox.setWhatsThis("")
        self.custompausetimesCheckBox.setChecked(False)
        self.custompausetimesCheckBox.setTristate(False)
        self.custompausetimesCheckBox.setObjectName("custompausetimesCheckBox")
        self.customthresholdsCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        self.customthresholdsCheckBox.setEnabled(True)
        self.customthresholdsCheckBox.setGeometry(QtCore.QRect(10, 400, 128, 17))
        self.customthresholdsCheckBox.setWhatsThis("")
        self.customthresholdsCheckBox.setChecked(False)
        self.customthresholdsCheckBox.setTristate(False)
        self.customthresholdsCheckBox.setObjectName("customthresholdsCheckBox")
        ...
        self.groupDummySplitsCheckBox.setGeometry(QtCore.QRect(240, 443, 261, 20))
        ...
        self.setpausehotkeyButton.setGeometry(QtCore.QRect(400, 416, 71, 21))
        ...
        self.loopCheckBox.setGeometry(QtCore.QRect(510, 314, 117, 20))
        ...
        self.autostartonresetCheckBox.setGeometry(QtCore.QRect(510, 344, 126, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.custompausetimesCheckBox.setText(_translate("MainWindow", "Custom pause times"))
        self.customthresholdsCheckBox.setText(_translate("MainWindow", "Custom thresholds"))
