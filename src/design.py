...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./res\\../../../../VideoAutoSplitter/icon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.currentsplitimageLabel.setGeometry(QtCore.QRect(430, 50, 221, 16))
