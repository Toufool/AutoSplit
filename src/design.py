...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitimagefolderLineEdit.setGeometry(QtCore.QRect(130, 10, 412, 22))
        ...
        self.similaritythresholdLabel.setGeometry(QtCore.QRect(7, 410, 151, 16))
        ...
        self.similaritythresholdDoubleSpinBox.setGeometry(QtCore.QRect(155, 408, 61, 22))
        ...
        self.showlivesimilarityCheckBox.setGeometry(QtCore.QRect(7, 323, 124, 20))
        ...
        self.showhighestsimilarityCheckBox.setGeometry(QtCore.QRect(7, 350, 145, 20))
        ...
        self.timerglobalhotkeysLabel.setGeometry(QtCore.QRect(230, 291, 251, 20))
        self.timerglobalhotkeysLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.currentsplitimageLabel.setGeometry(QtCore.QRect(450, 38, 102, 16))
        ...
        self.captureregionLabel.setGeometry(QtCore.QRect(200, 38, 82, 16))
        ...
        self.currentsplitimagefileLabel.setGeometry(QtCore.QRect(380, 50, 241, 20))
        ...
        self.startImageReloadButton.setGeometry(QtCore.QRect(500, 302, 121, 31))
        ...
        self.startImageLabel.setGeometry(QtCore.QRect(440, 270, 181, 20))
        self.startImageLabel.setObjectName("startImageLabel")
        self.currentsimilaritythresholdLabel = QtWidgets.QLabel(self.centralwidget)
        self.currentsimilaritythresholdLabel.setGeometry(QtCore.QRect(7, 380, 151, 16))
        self.currentsimilaritythresholdLabel.setObjectName("currentsimilaritythresholdLabel")
        self.currentsimilaritythresholdnumberLabel = QtWidgets.QLabel(self.centralwidget)
        self.currentsimilaritythresholdnumberLabel.setGeometry(QtCore.QRect(171, 380, 46, 16))
        self.currentsimilaritythresholdnumberLabel.setText("")
        self.currentsimilaritythresholdnumberLabel.setObjectName("currentsimilaritythresholdnumberLabel")
        self.captureregionwindowLabel = QtWidgets.QLabel(self.centralwidget)
        self.captureregionwindowLabel.setGeometry(QtCore.QRect(120, 50, 241, 20))
        self.captureregionwindowLabel.setText("")
        self.captureregionwindowLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.captureregionwindowLabel.setObjectName("captureregionwindowLabel")
        self.forcePrintWindowCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        self.forcePrintWindowCheckBox.setEnabled(True)
        self.forcePrintWindowCheckBox.setGeometry(QtCore.QRect(120, 270, 221, 20))
        self.forcePrintWindowCheckBox.setObjectName("forcePrintWindowCheckBox")
        ...
        self.captureregionwindowLabel.raise_()
        self.forcePrintWindowCheckBox.raise_()
        ...
        self.actionCheck_for_Updates_on_Open.setObjectName("actionCheck_for_Updates_on_Open")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.similaritythresholdLabel.setText(_translate("MainWindow", "Default similarity threshold:"))
        ...
        self.pauseLabel.setText(_translate("MainWindow", "Default pause time (sec):"))
        ...
        self.currentsimilaritythresholdLabel.setText(_translate("MainWindow", "Current similarity threshold:"))
        self.forcePrintWindowCheckBox.setText(_translate("MainWindow", "Force Full Content Rendering (slower)"))
        ...
        self.actionCheck_for_Updates_on_Open.setText(_translate("MainWindow", "Check for Updates on Open"))
