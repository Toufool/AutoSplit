...
CAPTURE_METHODS = OrderedDict({
    CaptureMethod.BITBLT: CaptureMethodInfo(
        ...
        description="A good default fast option. Allows recording background windows "
    ...
    CaptureMethod.WINDOWS_GRAPHICS_CAPTURE: CaptureMethodInfo(
        ...
        short_description="Windows 10 1903 and up, most compatible if available",
        description="Only available in recent Windows updates. Allows recording UWP apps "
    ...
    CaptureMethod.DESKTOP_DUPLICATION: CaptureMethodInfo(
        ...
        short_description="very slow, overlapping windows, supports OpenGL and DirectX 11/12 exclusive fullscreen",
        description="Duplicates the desktop using Direct3D. It can record OpenGL and Hardware Accelerated windows. "
        + "But it's about 10-15x slower than BitBlt and overlapping windows will show up.",
    ),
    CaptureMethod.PRINTWINDOW_RENDERFULLCONTENT: CaptureMethodInfo(
        ...
        description="Uses BitBlt behind the scene, but passes a special flag to PrintWindow to force rendering the "
