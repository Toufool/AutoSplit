...
class VideoAutoSplitter(QtGui.QMainWindow, design.Ui_MainWindow):
    ...
    def browse(self):
        ...
        #If the user doesn't select a folder, it defaults to \. Set it to No Folder Selected when this happens.
    ...
    def setSplitHotkey(self):
        ...
        def callback():
            ...
            #If the key the user presses is equal to that of itself or another hotkey already set,
            ...
            #hotkey. A try an except is needed if a hotkey hasn't been set yet.
            try:
    ...
    #check FPS button connects here.
    def checkFPS(self):
        #error checking
        ...
        #grab first image in the split image folder and generate its signature    
    ...
    def undoSplit(self):
        ...
        qImg = QtGui.QImage(self.split_image_display, self.split_image_display.shape[1], self.split_image_display.shape[0], self.split_image_display.shape[1]*3, QtGui.QImage.Format_RGB888)    
    ...
    def closeEvent(self, app):
        ...
        with open('settings.pkl','w') as f:
            pickle.dump([self.split_image_directory,self.similarity_threshold,self.pause,self.fps_limit,self.split_key,self.reset_key,self.skip_split_key,self.undo_split_key],f)
        sys.exit()
