...
- **Windows Graphics Capture** (fast, most compatible, capped at 60fps)  
    ...
    Due to current technical limitations, Windows versions below 10.0.17763 require having at least one audio or video Capture Device connected and enabled.
