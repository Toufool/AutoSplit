...
If _not_ using the LiveSplit Integration, you **must** disable "Double Tap Prevention" in LiveSplit settings. As it requires a 600ms delay between hotkeys. <!-- Keep in sync with start_also_resets_checkbox settings tooltip -->
