...
from ctypes import (Array, Structure, Union, c_char as c_char, c_int, c_int32 as c_int32, c_long, c_short, c_uint,
                    c_uint8, c_uint32 as c_uint32, c_wchar)
from ctypes.wintypes import (BOOL, DWORD, HHOOK, HMODULE, LONG, LPARAM, LPCWSTR, LPDWORD, LPMSG as LPMSG, LPWSTR, WCHAR,
                             WORD, WPARAM)
