...
from typing import Optional  # noqa: Y037  # mypy issue

from keyboard._canonical_names import all_modifiers as all_modifiers, sided_modifiers as sided_modifiers
...
def restore_state(scan_codes: Sequence[int]) -> None: ...
def restore_modifiers(scan_codes: Sequence[int]) -> None: ...
...
def get_hotkey_name(names: Sequence[str] | None = ...) -> str: ...
def read_event(suppress: bool = ...) -> KeyboardEvent: ...
def read_key(suppress: bool = ...) -> _Key: ...
def read_hotkey(suppress: bool = ...) -> str: ...
def get_typed_strings(events: Sequence[KeyboardEvent], allow_backspace: bool = ...) -> Generator[str, None, None]: ...
...
def play(events: Sequence[KeyboardEvent], speed_factor: float = ...) -> None: ...
