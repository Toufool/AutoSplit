...
def exec_script(script_filename: os.PathLike[AnyStr] | AnyOrLiteralStr,
                *args: str, env: _Environ | None = ...) -> str | int: ...
...
def include_or_exclude_file(
    filename: str, include_list: Iterable[str] | None = ..., exclude_list: Iterable[str] | None = ...
) -> bool: ...
