...
def GET_ALG_CLASS(x) -> int: ...


def GET_ALG_TYPE(x) -> int: ...


def GET_ALG_SID(x) -> int: ...
...
def RCRYPT_SUCCEEDED(rt) -> bool:
    ...


def RCRYPT_FAILED(rt) -> bool:
    ...
...
def GET_CERT_ENCODING_TYPE(X) -> int:
    ...


def GET_CMSG_ENCODING_TYPE(X) -> int:
    ...
